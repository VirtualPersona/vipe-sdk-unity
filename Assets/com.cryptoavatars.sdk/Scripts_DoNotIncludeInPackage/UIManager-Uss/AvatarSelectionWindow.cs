...
namespace BloodUI
{
    public class AvatarSelectionWindow : VisualElement
    {
        ...
        public event Action OnLoadOpenSourceRequested;
        // Style Path
        ...
        public Toggle openSourceToggle;         // 320x43
        ...
        public AvatarSelectionWindow()
        {
            ...
            logo = new Image();
            collectionSelector = new DropdownField() { label = "Collection", choices = new System.Collections.Generic.List<string>() { "CryptoAvatars" },
                value = "CryptoAvatars" };
            openSourceToggle = new Toggle() { label = "Open Source" };
            ...
            openSourceToggle.style.width = 320;
            openSourceToggle.style.height = 43;
            ...
            SelectorContainer.Add(openSourceToggle);
            HeaderContainer.Add(SelectorContainer);
            ...
            // Toggle
            openSourceToggle.RegisterValueChangedCallback(x => OnLoadOpenSourceRequested?.Invoke());
        }
